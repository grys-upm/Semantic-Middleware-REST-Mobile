...
public class ValidationUtils {
	...
	// I have created this method in order to resolve relative paths in references
	// "$ref" inside the schemas)
	public static boolean isJsonValid(JsonSchema jsonSchemaNode, String jsonText)
